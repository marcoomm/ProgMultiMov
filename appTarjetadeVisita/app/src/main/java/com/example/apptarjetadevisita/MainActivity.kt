...
fun Contenido(){
    Box(modifier = Modifier.fillMaxHeight().fillMaxSize().padding(5.dp)){
        Surface(modifier = Modifier.padding(3.dp).fillMaxHeight().fillMaxSize(),
...
private fun infoPerfil(){
    Column(modifier = Modifier.padding(5.dp),
        horizontalAlignment = Alignment.CenterHorizontally) {
        Text(text="Perico el de los palotes",
            style=MaterialTheme.typography.headlineMedium,
            color=MaterialTheme.colorScheme.primary)
        Text(text="Programador android",
            modifier = Modifier.padding(3.dp))
        Text(text="@developGuay",
            modifier = Modifier.padding(3.dp),
...
@Composable
fun AppTarjetaVisitaTheme(content: @Composable () -> Unit) {
